...
int main(){
    ...
    std::uniform_int_distribution<> distrib(0, 10); // 0 для добавления случая поиска элемента, не входящего в список
    ...
    std::ofstream outFile("Strat_uni.csv");
